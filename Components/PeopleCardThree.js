...
export default function PeopleCardThree(props) {
    ...
    return (
        ...
        <View style={styles.poster}>
            <ImageBackground
                source={props.cover}
                style={{flex: 1, width: width.poster}}
                imageStyle={{resizeMode: 'cover', borderTopLeftRadius: 22, borderTopRightRadius: 22, borderRadius: 22}}
            >
                <LinearGradient
                    colors={['rgba(44, 54, 63, 0.85)', 'rgba(255, 255, 255, 0)']}
                    style={{flex: 1, borderTopLeftRadius: 22, borderTopRightRadius: 22, borderRadius: 22, justifyContent: 'space-evenly'}}
                    start={[0.4, 1]}
                    end={[1, 0.1]}
                    //     start={{ x: 1, y: 1 }}
                    //     end={{ x: 1, y: 0 }}    
                >
                    <TouchableOpacity
                        style={{ padding: 8 }}
                    >
                        <Image source={props.profile} style={{ borderWidth: 2, borderColor: props.color, resizeMode: 'cover', width: 50, height: 50, borderRadius: 50}}/>
                    </TouchableOpacity>
