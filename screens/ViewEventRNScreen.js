...
function ViewEventRNScreen({ route, navigation }) {
    ...
    return (
        <View style={{flex: 1, marginTop: Constants.statusBarHeight}}>
            <View style={{flex: 0.1, elevation: 5, backgroundColor: 'white', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 12, paddingVertical: 2}}>
                {/*Style 1*/}
            ...
            <View style={{flex: 0.4, elevation: 5, backgroundColor: 'white', paddingHorizontal: 12, borderBottomLeftRadius: 50, borderBottomRightRadius: 50}}>
                <Text adjustsFontSizeToFit allowFontScaling numberOfLines={2} style={{fontFamily: 'Bold', fontSize: 26}}>
                    {name}
                </Text>

                <Text adjustsFontSizeToFit allowFontScaling numberOfLines={6} style={{fontFamily: 'Regular', fontSize: 15, paddingVertical: 6, paddingBottom: 10}}>
                    {desc}
                </Text>

                <View style={{flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 12,alignItems: 'center', paddingTop: 12, borderTopWidth: 1, borderTopColor: 'rgba(0,0,0,0.1)'}}>
